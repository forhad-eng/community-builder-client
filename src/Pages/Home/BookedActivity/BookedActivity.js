...
const BookedActivity = ({ bookedActivity }) => {
    const { activity, date, picture } = bookedActivity
    return (
        <div className="flex gap-5 shadow-lg rounded-md bg-white p-4 relative">
            ...
            <button className="bg-[#E3E3E3] text-[#787878] px-5 py-2 rounded-md absolute right-5 bottom-4">
                Cancel
            </button>
        </div>
    )
